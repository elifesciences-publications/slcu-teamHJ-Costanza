/**
 * Filename     : findCellBoasStack.cc
 * Description  : Finds cell basin of attractors (all voxels related to a 
 *              : specific center) in a stack of images.
 *              : Prints cell boas to stdout and plots cell boas with random
 *              : colors in original stack in output directory.
...
int main( int argc,char* argv[] ) {
  ...
  //Get the basins of attractions from the flag data
  //////////////////////////////////////////////////////////////////////
