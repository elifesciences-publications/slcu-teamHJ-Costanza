...
public class ProcessorOptionPanel extends java.awt.Panel {
    ...
    public ProcessorOptionPanel(MainFrame frame) {
        ...
        initComponents();
//        scrollPane1.setSize(new java.awt.Dimension(320, 250));
...
//                frame.update();
    ...
    private void initComponents() {
        ...
        scrollPane1.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentResized(java.awt.event.ComponentEvent evt) {
                scrollPane1ComponentResized(evt);
            }
        });
	...
	private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        private void scrollPane1ComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_scrollPane1ComponentResized
            doLayout();
        }//GEN-LAST:event_scrollPane1ComponentResized
